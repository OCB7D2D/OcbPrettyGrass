Shader "OCBNET/GrassShader"
{
    ...
    SubShader
    {
        ...
        void surf(Input i, inout SurfaceOutputStandardSpecularCustom o)
        {
            ...
            o.Albedo = albedo * (1 - _F1); // min(max(albedo, gaos.xxx), 1);
            o.Specular = gaos.xxx * 0.4 * (1 - _F2); //  _Smoothness;
            o.Smoothness = gaos.yyy * 0.3 * (1 - _F3); //  _Smoothness;
            o.Translucency = albedo * gaos.zzz * (1 - _F4); // * i.color
