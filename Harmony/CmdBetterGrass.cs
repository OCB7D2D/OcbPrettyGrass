...
public class GrassShadowCmd : ConsoleCmdAbstract
{
    ...
    private static string info = "BetterGrass";

    public override string[] GetCommands()
    {
        Log.Warning("Asked for Commands");
        return new string[2] { info, "grass" };
    }

    public override string GetDescription() => "Grass Shadows";
            ...
            switch (_params[0])
            {
                case "new":
                    MeshDescription.meshes[MeshDescription.MESH_GRASS].
                        material.shader = OcbBetterGrass.GrassShader;
                    break;
                case "old":
                    MeshDescription.meshes[MeshDescription.MESH_GRASS].
